      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="bg-slate-900/50 backdrop-blur-xl rounded-3xl p-8 border border-emerald-500/20 shadow-2xl shadow-emerald-500/10">
          ...
          <div className="text-center mb-8">
            <div className="w-20 h-20 mx-auto mb-6 rounded-2xl bg-gradient-to-br from-emerald-500 to-teal-600 flex items-center justify-center shadow-2xl shadow-emerald-500/50">
