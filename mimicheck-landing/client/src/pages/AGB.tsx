...
export default function AGB() {
  return (
    <FramerPageShell title="Allgemeine Geschäftsbedingungen (AGB)">
      <div className="prose prose-invert max-w-none">
        <h2>1. Geltungsbereich</h2>
        <p>
          Diese Allgemeinen Geschäftsbedingungen (AGB) gelten für alle Verträge
          zwischen der MiMi Tech Ai UG (haftungsbeschränkt), Lindenplatz 23,
          75378 Bad Liebenzell (nachfolgend "Anbieter") und dem Nutzer
          (nachfolgend "Kunde") über die Nutzung der Plattform MiMiCheck.
        </p>

        <h2>2. Vertragsgegenstand</h2>
        <p>
          MiMiCheck ist eine digitale Plattform zur Unterstützung bei der
          Beantragung von Förderungen und Leistungen. Die Plattform nutzt
          KI-Systeme zur Analyse von Dokumenten und zum automatischen Ausfüllen
        ...
        <p>
          ...
          MiMiCheck zustande. Mit der Registrierung akzeptiert der Kunde diese
          AGB.
        </p>
        <p>
          Der Kunde ist verpflichtet, bei der Registrierung wahrheitsgemäße und
          vollständige Angaben zu machen. Änderungen der Daten sind dem Anbieter
          unverzüglich mitzuteilen.
        </p>

        <h2>4. Leistungsumfang und Nutzung</h2>
        <p>
          Der Anbieter stellt die Plattform in der jeweils aktuellen Version zur
          Verfügung. Der Kunde hat keinen Anspruch auf eine bestimmte
          Funktionalität oder Verfügbarkeit.
        </p>
        <p>
          Der Anbieter behält sich das Recht vor, die Plattform jederzeit zu
          ändern, zu erweitern oder einzuschränken, soweit dies für den Kunden
          zumutbar ist.
        </p>

        <h2>5. KI-Systeme und Haftung</h2>
        <p>
          Die Plattform nutzt KI-Systeme zur Analyse und Verarbeitung von
          Dokumenten. Der Anbieter weist darauf hin, dass:
        </p>
        <ul>
          <li>KI-Systeme Fehler machen können</li>
          <li>
            Alle KI-Vorschläge von qualifizierten Mitarbeitern überprüft werden
          </li>
          <li>
            Der Kunde die finale Verantwortung für die Richtigkeit der Angaben
            trägt
          </li>
          <li>Der Kunde alle Vorschläge vor der Einreichung prüfen muss</li>
        </ul>
        <p>
          Der Anbieter haftet nicht für Schäden, die durch fehlerhafte
          KI-Vorschläge entstehen, sofern diese vom Kunden nicht geprüft wurden.
        </p>
        ...
        <p>
          Der Anbieter verpflichtet sich, alle personenbezogenen Daten des
          Kunden gemäß den geltenden Datenschutzbestimmungen (DSGVO) zu
          verarbeiten. Weitere Informationen finden Sie in unserer{" "}
          <Link
            href="/datenschutz"
        ...
        <p>
          Der Anbieter behandelt alle hochgeladenen Dokumente und Informationen
          vertraulich und gibt diese nicht an Dritte weiter, sofern dies nicht
          zur Erfüllung des Vertragszwecks erforderlich ist.
        </p>

        <h2>8. Vergütung und Zahlungsbedingungen</h2>
        <p>
          Die Nutzung der Plattform kann kostenlos oder kostenpflichtig sein.
          Die jeweils gültigen Preise werden auf der Plattform angezeigt.
        </p>
        <p>
          Zahlungen sind im Voraus fällig. Der Anbieter behält sich das Recht
          vor, die Nutzung bei Zahlungsverzug zu sperren.
        </p>

        <h2>9. Laufzeit und Kündigung</h2>
        <p>
          Der Vertrag wird auf unbestimmte Zeit geschlossen. Beide Parteien
          können den Vertrag jederzeit mit einer Frist von 14 Tagen kündigen.
        </p>
        <p>
        ...
        <p>
          Der Anbieter gewährleistet, dass die Plattform im Wesentlichen die
          beschriebenen Funktionen erfüllt. Kleinere Abweichungen oder Fehler,
          die die Nutzung nicht wesentlich beeinträchtigen, begründen keine
          Gewährleistungsansprüche.
        </p>
        <p>
          Der Anbieter ist berechtigt, Mängel durch Nachbesserung oder
          Ersatzlieferung zu beheben. Schlägt die Nacherfüllung fehl, kann der
          Kunde nach seiner Wahl Minderung verlangen oder vom Vertrag
          zurücktreten.
        </p>

        <h2>12. EU AI Act Konformität</h2>
        <p>
          Der Anbieter verpflichtet sich, die Anforderungen des EU AI Act
          (Verordnung (EU) 2024/1689) einzuhalten. Insbesondere:
        </p>
        <ul>
        ...
        <p>
          ...
          Änderungen werden dem Kunden per E-Mail mitgeteilt. Widerspricht der
          Kunde nicht innerhalb von 14 Tagen, gelten die geänderten AGB als
          akzeptiert.
        </p>
        ...
        <p>
          Gerichtsstand für alle Streitigkeiten aus diesem Vertrag ist, soweit
